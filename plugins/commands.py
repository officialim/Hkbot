...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('📞 Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/upBotUpdate"),
                    InlineKeyboardButton('🎥 Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url="https://t.me/expmovie")
                ],[
                    InlineKeyboardButton('⬇️ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url="https://t.me/expmovie")
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('📽️⌬Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url="https://t.me/expmovie")
                ],[
                    InlineKeyboardButton('📞 Hᴇʟᴘ', callback_data='help'),
                    InlineKeyboardButton('🐸 Aʙᴏᴜᴛ', callback_data='about')
                ],[
                    InlineKeyboardButton('🚀 Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url="https://t.me/expmovie")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAEJ_1pk154XmO7UAAGe0CJNKM_4T55XwFsAAicBAALIlGQU4j1igJFEppowBA") 
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("Mᴏᴠɪᴇ Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ", url="t.me/expmovie")
                         ]
                        ]
                    )
                )
    ...
    if not files_:
        ...
        try:
            ...
            title = '@expmovie ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
            ...
            k = await msg.reply("<b><u>🔴IMPORTANT🔴</u></b>\n\nThis Movie File/Video will be deleted in <b><u>10 mins</u> ☠️ <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there</i></b>",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
